...
function [functionsCallHistory, yOptimalVector, fitnessHistory, sigmaHistory] = MyMyILaSiSelfAdaptationES(sigmaMutation, sigmaStop, N, my, lambda, rho, fitnessCalculationFunction, maxIter)
    ...
    iterations = 0;
    functionCalls = my; % because of the above for loop
    ...
    while (sigmaMutation > sigmaStop) && (iterations < maxIter)
        ...
        functionsCallHistory(iterations + 1) = functionCalls;
